package cl.bch.cloud.ms.prd.cdto.aviso.cobro.bdg.controllers;

import cl.bch.cloud.ms.prd.cdto.aviso.cobro.bdg.dtos.MessageDTO;
import cl.bch.cloud.ms.prd.cdto.aviso.cobro.bdg.services.RandomService;
import cl.bch.cloud.ms.prd.cdto.aviso.cobro.bdg.logestandar.RandomDataLog;
import cl.bch.cloud.logging.annotation.LogEstandar;
...
public class RandomController {
    ...
    @LogEstandar(canal = "POC_ARQ",
            opcion = "RandomArq", subOpcion = "Random",
            dataLogTransaccional = RandomDataLog.class)
